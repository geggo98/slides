...
const LEVELS = [
  ...
  { id: 3, name: 'Pod / Instance', color: '#f97316', colorDim: 'rgba(249,115,22,0.15)' },
  { id: 4, name: 'Infrastructure', color: '#a855f7', colorDim: 'rgba(168,85,247,0.15)' },
]
...
const VIZ_TYPES = [
  {
    ...
    levels: [1, 2, 3, 4], sizing: '8\u201312 Spalten, 6\u20138 H\u00f6he',
  },
  {
    ...
    levels: [1, 2], sizing: '4\u20138 Spalten, 3\u20134 H\u00f6he',
  },
  {
    ...
    levels: [2, 3], sizing: '4\u20136 Spalten, 4\u20135 H\u00f6he',
  },
  {
    ...
    levels: [2], sizing: '12\u201324 Spalten, 8\u201310 H\u00f6he',
  },
  {
    ...
    levels: [2, 3, 4], sizing: '12\u201324 Spalten, 8\u201310 H\u00f6he',
  },
  {
    ...
    levels: [2, 3], sizing: '24 Spalten (volle Breite), 8\u201312 H\u00f6he',
  },
  {
    id: 'traces', name: 'Traces Panel', icon: '\u{1F517}',
    color: '#f472b6', colorDim: 'rgba(244,114,182,0.15)',
    useFor: 'Verteilte Traces als Gantt-Chart (Tempo)',
    examples: ['Request-Flow \u00fcber Services', 'Langsame Span-Identifikation', 'Dependency-Analyse'],
    tips: 'Trace-to-Logs und Trace-to-Metrics konfigurieren. Service-Map aus Tempo-Daten.',
    levels: [1, 2], sizing: '24 Spalten, 10\u201314 H\u00f6he',
  },
  {
    ...
    levels: [1], sizing: '12\u201324 Spalten, 4\u20136 H\u00f6he',
  },
  {
    ...
    levels: [1, 2], sizing: '8\u201312 Spalten, 6\u20138 H\u00f6he',
  },
  {
    id: 'text', name: 'Text Panel', icon: '\u{1F4DD}',
    color: '#94a3b8', colorDim: 'rgba(148,163,184,0.12)',
    useFor: 'Markdown-Kontext, Runbook-Links, Eskalationspfade',
    examples: ['Runbook-Link pro Service', 'SLO-Definition + Eskalationspfad', 'Architektur-Diagramm (Mermaid)', 'Team-Ownership / Kontaktinfo'],
    ...
    levels: [1, 2, 3], sizing: '6\u201312 Spalten, 3\u20136 Hoehe',
  },
  {
    ...
    examples: ['Overview -> Service (?var-service=X)', 'Service RED -> Pod USE (?var-pod=X)', 'Service -> Upstream-Provider-Detail', 'Panel Data Link -> Runbook (extern)'],
    ...
    levels: [1, 2, 3, 4], sizing: 'Header / Panel Data Links',
  },
]

const DECISION_MATRIX = [
  { q: 'Wie ver\u00e4ndert sich X \u00fcber die Zeit?', a: 'Time Series', icon: '\u{1F4C8}' },
  { q: 'Wie ist der aktuelle Wert eines KPIs?', a: 'Stat Panel', icon: '\u{1F522}' },
  { q: 'Wie voll ist eine Ressource (% von Max)?', a: 'Gauge', icon: '\u23F1\uFE0F' },
  { q: 'Wie verteilen sich Latenzen (Histogramm)?', a: 'Heatmap', icon: '\u{1F7E7}' },
  { q: 'Welche Endpoints sind am langsamsten?', a: 'Table', icon: '\u{1F4CB}' },
  { q: 'Was steht in den Logs zu diesem Fehler?', a: 'Logs Panel', icon: '\u{1F4DC}' },
  { q: 'Wie flie\u00dft ein Request \u00fcber alle Services?', a: 'Traces Panel', icon: '\u{1F517}' },
  { q: 'War der Service heute Nacht verf\u00fcgbar?', a: 'State Timeline', icon: '\u{1F6A6}' },
  { q: 'Welche Alerts feuern gerade?', a: 'Alert List', icon: '\u{1F514}' },
  { q: 'Wo ist das Runbook / wer ist Owner?', a: 'Text Panel', icon: '\u{1F4DD}' },
  { q: 'Drill-Down zum Pod / zur Infrastruktur?', a: 'Dashboard Links', icon: '\u{1F500}' },
]

const selectedViz = ref(props.initialSelectedViz)

watch(() => props.initialSelectedViz, (val) => {
  if (val) selectedViz.value = val
})

const vizDetail = computed(() => VIZ_TYPES.find(v => v.id === selectedViz.value))
