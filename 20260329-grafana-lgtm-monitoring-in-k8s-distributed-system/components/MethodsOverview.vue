...
const methods = computed(() => [
  {
    ...
    signals: [
      ...
      },
      {
        letter: "E",
        name: "Errors",
        desc: "Fehlgeschlagene Requests/s — User-Sicht",
        accent: C.value.red,
      ...
      },
      {
        letter: "D",
        name: "Duration",
        desc: "Latenz-Verteilung (p50, p95, p99)",
  ...
  },
  {
    ...
    signals: [
      ...
      },
      {
        letter: "E",
        name: "Errors",
        desc: "Infrastruktur-Fehler (ECC, Packet Drops)",
        accent: C.value.red,
        color: C.value.redDim,
      },
    ],
