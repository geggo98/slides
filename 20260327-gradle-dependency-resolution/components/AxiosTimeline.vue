...
const events = [
  {
    ...
    t: "~14. März",
    time: "",
    title: "Erster Kontakt mit Jason Saayman",
    crit: false,
  ...
  },
  {
    ...
    t: "~28. März",
    time: "",
    title: "Gefälschtes Teams-Meeting \u2013 ClickFix-Angriff",
    crit: true,
  ...
  },
  {
    ...
    t: "30. März",
    time: "05:57",
    title: "Decoy-Paket plain-crypto-js@4.2.0 veröffentlicht",
    crit: false,
  ...
  },
  {
    ...
    t: "30. März",
    time: "23:59",
    title: "Bösartige plain-crypto-js@4.2.1 mit Payload",
    crit: false,
  ...
  },
  {
    ...
    t: "31. März",
    time: "00:21",
    title: "axios@1.14.1 als \u00bblatest\u00ab veröffentlicht",
    crit: true,
  ...
  },
  {
    ...
    t: "31. März",
    time: "00:23",
    title: "Erste Infektion \u2013 89 Sekunden nach Veröffentlichung",
    crit: true,
  ...
  },
  {
    ...
    t: "31. März",
    time: "00:27",
    title: "Socket.dev-Scanner schlägt Alarm",
    crit: false,
  ...
  },
  {
    ...
    t: "31. März",
    time: "~00:39",
    title: "Bitdefender blockiert Ausführung auf Windows",
    crit: false,
  ...
  },
  {
    ...
    t: "31. März",
    time: "~01:00",
    title: "axios@0.30.4 als \u00bblegacy\u00ab veröffentlicht",
    crit: true,
  ...
  },
  {
    ...
    t: "31. März",
    time: "01:38",
    title: "Collaborator DigitalBrainJS startet Gegenmaßnahmen",
    crit: false,
    d: "Öffnet PR #10591, deprecatet die kompromittierten Versionen und kontaktiert npm-Support direkt. Problem: Als Collaborator (nicht Owner) fehlen ihm die Berechtigungen, die Versionen selbst zu entfernen \u2013 kritische Zeit geht verloren.",
  ...
  },
  {
    ...
    t: "31. März",
    time: "01:50",
    title: "Elastic Security Labs reicht GitHub Security Advisory ein",
    crit: false,
  ...
  },
  {
    ...
    t: "31. März",
    time: "03:15",
    title: "Bösartige axios-Versionen von npm entfernt",
    crit: true,
  ...
  },
  {
    ...
    t: "31. März",
    time: "03:29",
    title: "plain-crypto-js von npm entfernt",
    crit: false,
  ...
  },
  {
    ...
    t: "3. April",
    time: "",
    title: "Offizielles Post-Mortem (GitHub Issue #10636)",
    crit: false,
...
<template>
  <div class="axios-timeline">
    <div class="hdr">
      ...
      <div class="hdr-sub">
        UNC1069 / BlueNoroff — 14. März bis 3. April 2026 (UTC)
      </div>
    </div>
    ...
    <div class="track">
      <template
        ...
        :key="item.type === 'sep' ? 's-' + item.day : 'e-' + item.index"
      >
        ...
        <div v-else class="evt">
          <div
            class="marker"
            :class="['marker-ph' + item.event.ph, { crit: item.event.crit }]"
          ></div>
          <div
            class="card"
            :class="{ open: openCards[item.index] }"
            @click.stop="toggleCard(item.index)"
          >
            <div class="card-top">
              <span
                v-if="item.event.time"
                class="ts-label"
                :class="'ts-ph' + item.event.ph"
            ...
            <div class="detail">
              <p>{{ item.event.d }}</p>
              <div class="tags">
                <span v-for="tag in item.event.tags" :key="tag" class="tag">{{
                  tag
                }}</span>
              </div>
            </div>
