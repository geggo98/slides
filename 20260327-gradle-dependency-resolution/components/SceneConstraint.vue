...
<template>
  <div class="scene-wrap">
    <div class="scene-desc">
      <code>constraints { }</code> setzen eine bevorzugte Version, ohne die
      Dependency selbst einzuziehen. Wirkt nur, wenn die Dependency bereits im
      Graph ist (transitiv oder direkt).
    </div>
    <div class="graph">
      <div class="g-row">
        <GraphNode
          name="Your project"
          version="+ constraint jackson:2.18.3"
          variant="source"
        />
      </div>
