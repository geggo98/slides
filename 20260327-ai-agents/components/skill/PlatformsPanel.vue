  ...
  <div>
    <CollapsibleSection id="platform-overview" title="Plattform-Übersicht" :open="true">
      <table class="tbl">
        ...
        <tr><td><b>claude.ai (Web)</b></td><td>.zip-Upload über Settings</td><td>Vorgefertigte + Partner-Skills</td><td>Kein CLI-Zugriff</td></tr>
        <tr><td><b>Claude API</b></td><td>container-Parameter</td><td>Max 8 Skills/Request</td><td><span class="dng">Kein Netzwerk, keine Runtime-Pakete</span></td></tr>
        <tr><td><b>OpenAI Codex</b></td><td>SKILL.md + AGENTS.md im Repo</td><td>Standard-Felder, AGENTS.override.md</td><td>Keine CC-Erweiterungen</td></tr>
        <tr><td><b>Cursor</b></td><td>SKILL.md + AGENTS.md + .cursorrules</td><td>Standard-Felder</td><td>Keine CC-Erweiterungen</td></tr>
        <tr><td><b>Gemini CLI</b></td><td>SKILL.md + AGENTS.md im Repo</td><td>Standard-Felder</td><td>Keine CC-Erweiterungen</td></tr>
      </table>
    </CollapsibleSection>

    <CollapsibleSection id="cc-storage" title="Claude Code — Speicherorte & Priorität">
      <div class="flow">
        <div class="flow-box fb-red">Enterprise<br><span class="flow-sub">Managed Settings</span></div>
        <span class="flow-arrow">&#9656;</span>
        <div class="flow-box fb-purple">Persönlich<br><span class="flow-sub">~/.claude/skills/</span></div>
        <span class="flow-arrow">&#9656;</span>
        <div class="flow-box fb-teal">Projekt<br><span class="flow-sub">.claude/skills/</span></div>
        <span class="flow-arrow">&#9656;</span>
        <div class="flow-box fb-amber">Plugin<br><span class="flow-sub">plugin/skills/</span></div>
      </div>
      <div class="callout">
        <b>AGENTS.md-Workaround für Claude Code:</b> Da Claude Code AGENTS.md nicht nativ liest, kann man es per <code>@Import</code> in die CLAUDE.md einbinden: <code>See @AGENTS.md for cross-tool conventions.</code>
      </div>
    </CollapsibleSection>
  </div>
</template>
