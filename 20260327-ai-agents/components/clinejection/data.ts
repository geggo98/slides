...
export const STEPS: AttackStep[] = [
  ...
  },
  {
    ...
    icon: "\u{1F916}",
    detail:
      "Claude interpretiert die Injection als legitime Aufgabe und f\u00fchrt `npm install` mit dem Angreifer-Fork aus. Das package.json des Forks enth\u00e4lt ein preinstall-Skript, das eine Remote-Shell-Payload herunterl\u00e4dt und ausf\u00fchrt. In Adnan Khans Tests \u201ef\u00fchrte Claude die Payload in allen Versuchen bereitwillig aus.\u201c",
    ...
    prereq:
      "Der Triage-Bot hatte uneingeschr\u00e4nkten Bash-Zugang \u2014 eine Konfiguration, die OWASP LLM06 (Excessive Agency) in allen drei Dimensionen verletzt: \u00fcberm\u00e4\u00dfige Funktionalit\u00e4t, Berechtigungen und Autonomie.",
  },
  {
    id: "cache",
    phase: "PERSISTENCE",
    ...
    prereq:
      "GitHub Actions Caches sind branch-\u00fcbergreifend les- und schreibbar f\u00fcr alle Workflows auf dem Default-Branch. Es gibt keine Zugriffskontrolle zwischen Workflows.",
  },
  {
    id: "credential",
    ...
    icon: "\u{1F511}",
    detail:
      "Clines n\u00e4chtlicher Publish-Workflow (publish-nightly.yml, ~2:00 UTC) restauriert den kompromittierten Cache. Beim Ausf\u00fchren der vergifteten actions/checkout Post-Step-Phase exfiltriert Cacheract drei Geheimnisse: VSCE_PAT (VS Code Marketplace), OVSX_PAT (OpenVSX) und NPM_RELEASE_TOKEN.",
    ...
    prereq:
      "Nightly-Credentials = Produktions-Credentials. Keine Trennung zwischen Test- und Release-Infrastruktur.",
  },
  {
    id: "publish",
    phase: "IMPACT",
    ...
    prereq:
      "Zwischen Khans Disclosure (9. Feb) und dem Angriff (17. Feb) scheiterte die Token-Rotation: Das Cline-Team l\u00f6schte versehentlich das falsche Token.",
  },
];
...
export const THWARTED: ThwartedAttack[] = [
  {
    ...
    detail:
      "Der Angreifer besa\u00df zeitweise den VSCE_PAT. Eine kompromittierte Extension h\u00e4tte \u00fcber Auto-Updates Millionen Entwicklermaschinen erreicht. Verhindert durch rechtzeitige Rotation des VSCE_PAT am 9. Februar.",
  ...
  },
  {
    ...
    detail:
      "\u00dcber OpenVSX werden VS-Code-kompatible Editoren (VSCodium, Gitpod, Eclipse Theia) bedient. Verhindert durch Rotation des OVSX_PAT.",
  ...
  },
  {
    ...
    detail:
      "Eine modifizierte Extension h\u00e4tte MCP-Server-Konfigurationen \u00fcberschreiben, API-Keys exfiltrieren oder beliebigen Code im Kontext des Entwicklers ausf\u00fchren k\u00f6nnen \u2014 mit Zugang zu jedem Projekt, das der Nutzer \u00f6ffnet.",
  ...
  },
  {
    ...
    detail:
      "OpenClaw auf Entwicklermaschinen h\u00e4tte als Br\u00fcckenkopf f\u00fcr weitere Supply-Chain-Angriffe dienen k\u00f6nnen: Zugang zu .npmrc, .git-credentials, SSH-Keys, Cloud-Provider-Tokens. Jedes Projekt des betroffenen Entwicklers w\u00e4re kompromittierbar.",
    reason:
      "Schnelle Erkennung durch StepSecurity (14 Min.) und Socket.dev begrenzte Downloads auf ~4.000",
  },
];
...
export const TIMELINE: TimelineEvent[] = [
  {
    date: "21. Dez 2025",
    event: "Triage-Workflow hinzugef\u00fcgt",
    type: "vuln",
  },
  ...
  {
    date: "9.\u201311. Feb",
    event: "Token-Rotation (fehlerhaft)",
    type: "fail",
  },
