...
const P = computed(() => isDark.value ? {
  ...
  accentBg: isDanger.value ? 'rgba(240,96,96,0.12)' : 'rgba(224,160,48,0.12)',
  accentBorder: isDanger.value ? 'rgba(240,96,96,0.25)' : 'rgba(224,160,48,0.25)',
  activeShadow: isDanger.value ? 'rgba(240,96,96,0.08)' : 'rgba(224,160,48,0.08)',
  codeBg: '#2a2a2e',
  prereqBg: '#2a2a2e',
  ...
  accentBg: isDanger.value ? 'rgba(192,64,64,0.08)' : 'rgba(160,112,32,0.08)',
  accentBorder: isDanger.value ? 'rgba(192,64,64,0.25)' : 'rgba(160,112,32,0.25)',
  activeShadow: isDanger.value ? 'rgba(192,64,64,0.05)' : 'rgba(160,112,32,0.05)',
  codeBg: '#f5f5f5',
  prereqBg: '#f5f5f5',
...
.step-card:hover { border-color: v-bind('P.hoverBorder'); border-left-color: v-bind('P.accentColor'); }
.step-card.active {
...
.step-meta { display: flex; align-items: center; gap: 6px; }
.step-num {
...
.step-date {
  font-size: 9px; color: v-bind('P.textTertiary');
  font-family: v-bind('P.fontMono');
}
.step-title {
...
.toggle-hint {
  font-size: 8px; color: v-bind('P.accentColor');
  margin-left: 4px;
}
