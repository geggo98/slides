...
import pivot from "./auto-mode-gates.json";

// Daten vollständig aus auto-mode-gates.json (wiederverwendbar):
...
<template>
  <div ref="rootEl" class="pivot">
    ...
    <div class="legend">
      <span
        ><span class="lg" :style="{ color: C.yes }">✓</span> ja /
        vorhanden</span
      >
      <span
      ...
      >
      <span
        ><span class="lg" :style="{ color: C.no }">✗</span> nein / kein
        Boundary</span
      >
